...
export const detailedAbout = {
    ...
    "techStack": [{ image: "images/aboutImages/code-stable-white.png", alt: "Visual Studio Code" }, { image: "images/aboutImages/java.png", alt: "Java" }, { image: "images/aboutImages/python.png", alt: "Python" }, { image: "images/aboutImages/cpp.png", alt: "C++" }
