...
export const professional = [
    ...
    'Former ULC Tutor @ CSUF',
    'I was an Open Source ACM Board member!',
    'I was a project lead for Open Source Stats!',
    'I have previously assisted students in Business Calc, Calc II, and Calc III.',
];
export const randomFactsAboutMe = [
    ...
    'I sometimes play Umamusume: Pretty Derby',
...
export const projects = [
    {
        ...
        techStack: ["React", "CSS", "HTML", "JavaScript", "Firebase", "Figma"],
